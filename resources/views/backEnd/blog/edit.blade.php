...
<div class="container-fluid">
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="{{route('blogs.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('description1') is-invalid @enderror" name="description1" rows="6"   id="description1">{{ $edit_data->description1 }}</textarea>
                            @error('description1')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('description2') is-invalid @enderror" name="description2" rows="6"   id="description2">{{ $edit_data->description2 }}</textarea>
                            @error('description2')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('description3') is-invalid @enderror" name="description3" rows="6"   id="description3">{{ $edit_data->description3 }}</textarea>
                            @error('description3')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('description4') is-invalid @enderror" name="description4" rows="6"   id="description4">{{ $edit_data->description4 }}</textarea>
                            @error('description4')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
