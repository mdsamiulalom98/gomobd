                ...
                <form action="{{route('blogs.store')}}" method="POST" class="row" data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('description1') is-invalid @enderror" name="description1" rows="6" value="{{ old('description1') }}"  id="description1"></textarea>
                            @error('description1')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
