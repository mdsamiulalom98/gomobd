            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('products.create') }}" class="btn btn-danger rounded-pill"><i
                                class="fe-shopping-cart"></i> Add Product</a>
                    </div>
                                ...
                                <table class="table nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:50%">Name - Size / Region</th>
                                    ...
                                    <tbody>
                                        @foreach ($products as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->product->name ?? "Product" }} <br> <span class="btn btn-blue">{{ $value->size }}</span> <span class="btn btn-pink">{{ $value->region }}</span></td>
