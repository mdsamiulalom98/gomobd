                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                value="{{ $customer->name ?? old('name') }}" placeholder="Enter Your Name" required />
                                            @error('name')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" minlength="11" id="number" maxlength="11"
                                                ...
                                                value="{{ $customer->phone ?? old('phone') }}" placeholder="Enter your mobile number" required />
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="address" id="address"
                                                ...
                                                name="address" placeholder="Enter your full address" value="{{ $customer->address ?? old('address') }}" required />
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="area"><i class="fa-solid fa-truck"></i> Delivery Area  *</label>
                                    ...
                                    @foreach (Cart::instance('shopping')->content() as $value)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                @endif
                                                @if ($value->options->product_region)
                                                    <p>Region: {{ $value->options->product_region }}</p>
                                                @endif
                                            </td>
                                            <td class="cart_qty">
